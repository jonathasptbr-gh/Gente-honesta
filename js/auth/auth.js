...
function setButtonLoading(btn, label) {
  ...
  btn.innerHTML = `<svg class="material-symbols-rounded btn__spinner" aria-hidden="true"><use href="#ic-autorenew"></use></svg> ${label}`;
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('btn-resend-sms')?.addEventListener('click', async () => {
    ...
    btnResend.innerHTML = '<svg class="material-symbols-rounded btn__spinner btn__spinner--sm" aria-hidden="true"><use href="#ic-autorenew"></use></svg>Enviando...';
